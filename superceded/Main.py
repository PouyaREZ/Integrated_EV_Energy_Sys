...
Optimize_EV_Load_On_CCHP = True # If true, percentage of EV Charging will be optimized
Percent_EV_Load_On_CCHP = 100 # Percentage of EV charging load carried by the CCHP set as a constant
...
#    GW_Efficiency = np.nan_to_num(Total_Treated_GW/Total_GW) ## Added the nan_to_number
    ...
    for i in range(Project_Life):
        ...
        LCC_Total += (CCHP_Opex)/(1+Discount_Rate)**i # + WWT_Opex_Total # Total LCC for the record
